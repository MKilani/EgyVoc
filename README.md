...
The algorithm is able to recognize irregularities in the corresponds between the forms - in that case, an error message is output instead of the reconstruction.
...
The file EgyVoc_tester.py can be downloaded from the GitHub repository https://github.com/MKilani/EgyVoc/blob/master/EgyVoc_tester.py
